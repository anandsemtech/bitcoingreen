Contributing to Bitcoin Neutral Core
==================================

The Bitcoin Neutral Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Bitcoin Neutral Core project, and is not to be
confused with overall Bitcoin Neutral Network Protocol consensus changes.

Whether a pull request is merged into Bitcoin Neutral Core rests with the project merge
...
Patches that change Bitcoin Neutral consensus rules are considerably more involved than
...
Where a patch set proposes to change the Bitcoin Neutral consensus, it must have been
...
The project leader is the release manager for each Bitcoin Neutral Core release.
