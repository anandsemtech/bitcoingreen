...
#if defined(NDEBUG)
#error "Bitcoin Neutral cannot be compiled without assertions."
#endif
...
{
    RenameThread("bitcoinneutral-scriptch");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // BTCN: We use certain sporks during IBD, so check to see if they are
