...
// Copyright (c) 2017-2018 The Bitcoin Neutral developers
...
public:
    ...
    /// Is the inputs associated with this public key? (and there is BTCN collateral - checking if valid masternode)
