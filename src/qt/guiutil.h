...
/** Utility functions used by the BitcoinNeutral Qt UI.
 */
namespace GUIUtil
{
...
// Render BTCN addresses in monospace font
...
// Parse "bitcoinneutral:" URI into recipient object, return true on successful parsing
