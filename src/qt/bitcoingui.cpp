                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Bitcoin Neutral Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BTCN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitcoinneutral: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Bitcoin Neutral Core"), this);
    aboutAction->setStatusTip(tr("Show information about Bitcoin Neutral Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Bitcoin Neutral"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BTCN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BTCN addresses"));
    ...
    openAction->setStatusTip(tr("Open a bitcoinneutral: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Bitcoin Neutral Core help message to get a list with possible Bitcoin Neutral command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Bitcoin Neutral Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bitcoin Neutral network", "", count));
}
...
{
    QString strTitle = tr("Bitcoin Neutral Core"); // default title
    ...
    // Append title to "Bitcoin Neutral - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
