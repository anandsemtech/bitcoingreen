...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Bitcoin Neutral Core"),
     ...
     * override -datadir in the bitcoinneutral.conf file in the default data directory
     * (to be consistent with bitcoinneutrald behavior)
     */
    if (dataDir != getDefaultDataDirectory())
