...
This mechanism has been integrated into Bitcore-Node-BitcoinNeutral which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bitcoinneutral/insight-api-bitcoinneutral#web-socket-api](https://github.com/bitcoinneutral/insight-api-bitcoinneutral#web-socket-api)
* API: [https://github.com/bitcoinneutral/insight-api-bitcoinneutral#swifttx-transactions](https://github.com/bitcoinneutral/insight-api-bitcoinneutral#swifttx-transactions)
...
By default, the Bitcoin Neutral Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Bitcoin Neutral Core daemon:
