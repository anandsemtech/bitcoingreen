...
In order to support loading of multiple wallets in bitcoinneutral-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bitcoinneutral.cpp.
...
Changes to bitcoinneutral.cpp
----------------------
bitcoinneutral.cpp is the entry point into bitcoinneutral-qt, and as such, will require some minor modifications to provide hooks for
