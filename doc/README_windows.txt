Bitcoin Neutral Core
=====================

Intro
-----
Bitcoin Neutral (BTCN) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Bitcoin Neutral utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run bitcoinneutral-qt.exe.

Bitcoin Neutral Core is the original Bitcoin Neutral client and it builds the backbone of the network.
However, it downloads and stores the entire history of Bitcoin Neutral transactions;
